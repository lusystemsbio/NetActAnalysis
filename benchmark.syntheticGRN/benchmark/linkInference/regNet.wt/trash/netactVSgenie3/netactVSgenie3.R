...
# genie3.aucell - link inference is performed using AUCell activities
# regulon db with the following perturbations: 0, 5, 10, 15 
...
ppvRcall.list[['ppvRcall.genie3.aucell.regdb05']] <- read.table("../../../../sim.genie3/regNet.wt/linksFromAUcellAct/regdb05/data/precision-recall.tsv", sep = '\t')
ppvRcall.list[['ppvRcall.genie3.aucell.regdb10']] <- read.table("../../../../sim.genie3/regNet.wt/linksFromAUcellAct/regdb10/data/precision-recall.tsv", sep = '\t')
ppvRcall.list[['ppvRcall.genie3.aucell.regdb15']] <- read.table("../../../../sim.genie3/regNet.wt/linksFromAUcellAct/regdb15/data/precision-recall.tsv", sep = '\t')
...
#                  'genie3+aucell(regdb00)', 'genie3+aucell(regdb05)', 'genie3+aucell(regdb10)', 'genie3+aucell(regdb15)')
 method.names <- c('NetAct (original regulons)',  'NetAct (25% perturbation)', 
                   'NetAct (50% perturbation)', 'NetAct (75% perturbation)', 
                  'GENIE3 + AUCell (original regulons)', 'GENIE3 + AUCell (25% perturbation)', 
                  'GENIE3 + AUCell (50% perturbation)', 'GENIE3 + AUCell (75% perturbation)')
length(method.names)
