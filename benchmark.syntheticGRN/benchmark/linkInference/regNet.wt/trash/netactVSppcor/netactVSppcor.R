...
# ppcor.netact - link inference is performed using AUCell activities
# regulon db with the following perturbations: 0, 5, 10, 15 
...
ppvRcall.list[['ppvRcall.ppcor.netact.regdb05']] <- read.table("../../../../sim.ppcor/regNet.wt/linksFromNetAct/regdb05/data/precision-recall.tsv", sep = '\t')
ppvRcall.list[['ppvRcall.ppcor.netact.regdb10']] <- read.table("../../../../sim.ppcor/regNet.wt/linksFromNetAct/regdb10/data/precision-recall.tsv", sep = '\t')
ppvRcall.list[['ppvRcall.ppcor.netact.regdb15']] <- read.table("../../../../sim.ppcor/regNet.wt/linksFromNetAct/regdb15/data/precision-recall.tsv", sep = '\t')
...
method.names <- c('netact(regdb00)',  'netact(regdb05)', 'netact(regdb10)', 'netact(regdb15)', 
                  'ppcor+netact(regdb00)', 'ppcor+netact(regdb05)', 'ppcor+netact(regdb10)', 'ppcor+netact(regdb15)'
