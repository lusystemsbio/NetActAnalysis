...
# regulon db with the following perturbations: 0, 5, 10, 15 
ppvRcall.list[['ppvRcall.grnboost2.aucell.regdb00']] <- read.table("../../sim.grnboost2/linksFromAUcellAct/regdb00/data/precision-recall.tsv", sep = '\t')
ppvRcall.list[['ppvRcall.grnboost2.aucell.regdb05']] <- read.table("../../sim.grnboost2/linksFromAUcellAct/regdb05/data/precision-recall.tsv", sep = '\t')
ppvRcall.list[['ppvRcall.grnboost2.aucell.regdb10']] <- read.table("../../sim.grnboost2/linksFromAUcellAct/regdb10/data/precision-recall.tsv", sep = '\t')
ppvRcall.list[['ppvRcall.grnboost2.aucell.regdb15']] <- read.table("../../sim.grnboost2/linksFromAUcellAct/regdb15/data/precision-recall.tsv", sep = '\t')
